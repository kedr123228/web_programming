...
│   ├── hero__2.css         # Стили главной секции часть 2
│   ├── hero__3.css         # Стили главной секции часть 3
...
- **`comment.css`** - Стили секции с комментарием
- **`hero__2.css`** - Стили секции с текстом и фото
- **`hero__3.css`** - Стили секции с текстом и кнопками
- **`blog.css`** - Стили блога
- **`team.css`** - Стили секции с командой
- **`registration.css`** -  Стили регистрации
